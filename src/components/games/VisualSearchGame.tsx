...
const VisualSearchGame = ({ onScoreChange, onGameEnd, difficulty = 'medium' }: VisualSearchGameProps) => {
  ...
  const generateTrial = () => {
    ...
    for (let i = 0; i < setSize; i++) {
      ...
      } while (shape === tShape && color === tColor);
    ...
    return (
      <div className="text-center space-y-4 py-8">
        ...
        <p className="text-muted-foreground max-w-md mx-auto">
          Find the target shape among distractors as quickly as possible. If the target is absent, click "Not Present."
        </p>
  ...
  return (
    <div className="flex flex-col items-center space-y-4">
      ...
      <Button variant="outline" onClick={handleAbsent} disabled={!!feedback}>
        Not Present
      </Button>
    </div>
  );
